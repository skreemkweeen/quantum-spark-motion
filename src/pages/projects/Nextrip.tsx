...
const Atmos = ({ variant = "ambient" }: { variant?: "hero" | "ambient" | "wide" | "stage" }) => (
  <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
    {variant === "hero" && (
      <>
        ...
        />
        <div
          className="absolute -inset-x-1/4 top-1/3 h-2/3 -rotate-12 opacity-[0.05]"
          style={{
    ...
    {variant === "stage" && (
      <>
        <div
          className="absolute inset-0"
          style={{
            background: "radial-gradient(ellipse 65% 70% at 50% 45%, rgba(220,228,240,0.12), transparent 65%)",
          }}
        />
        <div
          className="absolute inset-0"
    ...
    {variant === "wide" && (
      <div
        className="absolute inset-0"
        style={{
          background: "radial-gradient(ellipse 80% 50% at 50% 50%, rgba(210,220,235,0.06), transparent 70%)",
        }}
      />
    )}
    <div
...
const Ghost = ({
  ...
  <div
    ...
    style={{
      ...
      background:
        "linear-gradient(180deg, rgba(244,244,245,0.08) 0%, rgba(120,120,130,0.05) 50%, rgba(244,244,245,0.08) 100%)",
...
const Nextrip = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden text-white" style={{ background: "#040408" }}>
      ...
      {/* nav */}
      <nav
        className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between px-8 py-6 backdrop-blur-md"
        style={{ background: "linear-gradient(180deg, rgba(4,4,8,0.85), transparent)" }}
      >
        <Link to="/" style={{ ...label, color: "rgba(240,237,232,0.7)" }}>
          ← Index
        </Link>
        <NWordmark />
      ...
      <main className="relative z-10">
        ...
        <section id="hero" className="relative overflow-hidden px-6 pt-32 pb-40 md:pb-56 lg:pb-72">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute inset-x-0 top-[60%] h-px"
            style={{
          ...
          <div className="relative mx-auto max-w-7xl">
              ...
              <div className="flex flex-wrap items-start justify-between gap-6">
                ...
                <div className="flex items-start gap-12">
                  <div>
                    ...
                    <div
                      className="mt-2"
                      style={{ fontFamily: fontDisplay, fontWeight: 700, fontSize: "1rem", letterSpacing: "0.02em" }}
                    >
                      Travel Platform
                    </div>
                  </div>
                  ...
                  <span
                    ...
                    style={{ borderColor: "rgba(255,255,255,0.12)", color: "rgba(255,255,255,0.4)", fontSize: "10px" }}
                  >
                    ©
                  </span>
                </div>
            ...
            <div className="relative mt-32 flex min-h-[78vh] items-center justify-center">
              <Ghost align="center" className="top-1/2 -translate-y-1/2">
                nextrip
              </Ghost>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "inset 0 1px 0 rgba(255,255,255,0.18), 0 30px 50px -20px rgba(0,0,0,0.9), 0 0 50px -10px rgba(220,228,240,0.18)",
                  }}
                >
                  <NMark size={32} />
                </div>
              ...
              <div className="absolute left-0 top-[10%] hidden md:block" style={labelXS}>
                <div>N 40°42′</div>
                <div className="mt-1" style={{ ...labelXS, color: "rgba(255,255,255,0.18)" }}>
                  Altitude · 38,000 ft
                </div>
              </div>
            ...
            <div className="relative grid gap-x-10 gap-y-20 lg:grid-cols-12">
              ...
              <div className="lg:col-span-5 lg:pt-6">
                <Reveal>
                  ...
                  <p
                    className="mt-12"
                    style={{ ...labelXS, lineHeight: 1.9, color: "rgba(255,255,255,0.5)", maxWidth: "32ch" }}
                  >
                    An intelligent travel platform
                    <br />
                    composed for the modern traveler.
                  </p>
                </Reveal>
                <Reveal delay={0.2}>
                  <div className="mt-24">
                    ...
                    >
                      Millions of travelers face scattered options and complex planning. NexTrip composes everything
                      into one{" "}
              ...
              <div className="relative hidden lg:col-span-2 lg:block">
                ...
                />
                <div
                  className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rotate-90 whitespace-nowrap"
                  style={{ ...labelXS, color: "rgba(255,255,255,0.22)" }}
                >
                ...
                <Reveal delay={0.15}>
                  <div className="lg:max-w-[28ch]">
                    ...
                    >
                      ...
                      <em style={{ fontStyle: "italic" }}>experience</em> the world.
                    </p>
                    <Hairline className="mt-8 max-w-[6rem]" />
                    <p
                      className="mt-6"
                      style={{ ...labelXS, lineHeight: 1.9, color: "rgba(255,255,255,0.4)", maxWidth: "32ch" }}
                    >
          ...
          <div className="relative mx-auto max-w-7xl px-8 py-32 md:py-48">
            ...
            <Reveal>
              <div className="mb-16 max-w-2xl">
                ...
                >
                  A system <em style={{ fontStyle: "italic" }}>built for the traveler</em> — sculpted in graphite, lit
                  in silver.
                </p>
              </div>
            </Reveal>
                ...
                <Glass className="flex aspect-[3/4] flex-col p-8">
                  ...
                  <div className="relative my-auto flex justify-center">
                    <div
                      ...
                      style={{
                        background:
                          "radial-gradient(ellipse 60% 60% at 50% 50%, rgba(230,236,248,0.12), transparent 65%)",
                        filter: "blur(30px)",
                      }}
                    />
                    <img
                      ...
                      style={{
                        filter: "drop-shadow(0 40px 50px rgba(0,0,0,0.9)) drop-shadow(0 0 30px rgba(220,232,250,0.14))",
                      }}
                    />
                  </div>
                  <div>
                ...
                <Reveal delay={0.25}>
                  <Glass className="p-7">
                    ...
                    <div
                      ...
                      style={{ ...labelXS, fontSize: "7px", letterSpacing: "0.3em" }}
                    >
                      <span>040408</span>
                      <span>191921</span>
                      <span>3A3A44</span>
                  ...
                  <Glass className="flex-1 p-7">
                    ...
                    <div className="mt-5 flex items-end gap-7">
                      ...
                      <div className="pb-2">
                        ...
                        <div className="mt-1" style={{ ...labelXS, fontFamily: fontMono }}>
                          + DM Mono
                        </div>
                      </div>
                    </div>
        ...
        <section id="splash" className="relative">
          ...
          <div className="relative mx-auto max-w-7xl px-8 py-32 md:py-48">
            <Atmos variant="stage" />
            <Ghost align="left" className="top-1/2 -translate-y-1/2">
              NEXTRIP
            </Ghost>
            ...
            <Reveal delay={0.15} y={40}>
              <div className="relative">
                ...
                <div
                  aria-hidden
                  className="pointer-events-none absolute left-1/2 top-1/2 h-[60%] w-[85%] -translate-x-1/2 -translate-y-1/2"
                  style={{
                ...
                <Device float={false}>
                  <img
                    ...
                    style={{
                      filter:
                        "drop-shadow(0 30px 50px rgba(0,0,0,0.85)) drop-shadow(0 80px 140px rgba(0,0,0,0.95)) drop-shadow(0 0 80px rgba(220,232,250,0.18))",
                    }}
                  />
                </Device>
              </div>
          ...
          <div className="relative mx-auto max-w-7xl px-8 py-32 md:py-48">
            ...
            <Reveal>
              <div className="relative mx-auto max-w-3xl text-center">
                ...
                >
                  Simplified and personalized — composed for the highest degree of{" "}
                  <em style={{ fontStyle: "italic" }}>comfort</em>.
                </h3>
                <Hairline className="mx-auto mt-10 max-w-[120px]" />
                <p className="mx-auto mt-8 max-w-md" style={{ ...labelXS, lineHeight: 1.9, fontSize: "11px" }}>
                  Researched against the leading applications in the industry — every shortcoming refined into the
                  smallest, calmest gesture.
                </p>
          ...
          <div className="relative mx-auto max-w-7xl px-8 py-32 md:py-48">
            ...
            <div className="relative grid gap-12 lg:grid-cols-12 lg:gap-16">
              ...
              <Reveal delay={0.25} className="lg:col-span-3">
                ...
                >
                  Connection between screens, providing the development team a clear map of overall functionality before
                  any interface element is designed.
                </p>
              </Reveal>
            </div>
          </div>
          ...
          <div className="relative mx-auto max-w-7xl px-8 py-32 md:py-48">
            ...
            <div className="relative grid gap-16 lg:grid-cols-12 lg:items-center lg:gap-24">
              <Reveal className="lg:col-span-5 lg:pl-4">
                ...
                >
                  Choosing a travel option becomes effortless — curated rides, transparent pricing, and a flow that
          ...
          <div className="relative mx-auto max-w-7xl px-8 py-32 md:py-48">
            ...
            <div className="relative grid gap-12 md:grid-cols-[1fr_1.7fr_0.9fr] md:items-center md:gap-16">
              <Reveal>
                ...
                >
                  Bali —<br />
                  <em style={{ fontStyle: "italic", color: "rgba(255,255,255,0.55)" }}>Indonesia</em>
                </h4>
                <Hairline className="my-7 max-w-[80px]" />
                <div
                  className="flex items-center gap-3"
                  style={{ ...labelXS, color: "rgba(255,255,255,0.65)", letterSpacing: "0.2em", fontSize: "10px" }}
                >
              ...
              <Reveal delay={0.15} y={36}>
                <div className="relative overflow-hidden rounded-xl">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, rgba(0,0,0,0.3) 0%, transparent 30%, transparent 55%, rgba(4,4,8,0.92) 100%)",
                    }}
                  />
                  ...
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 flex items-end justify-between p-5">
                    <div style={labelXS}>
                      ...
                      <div className="mt-1" style={{ ...labelXS, color: "rgba(255,255,255,0.4)" }}>
                        From $699 / Person
                      </div>
                    </div>
              ...
              <Reveal delay={0.3}>
                <Glass className="p-6">
                  <div
                    className="mb-3"
                    style={{ ...labelXS, fontSize: "10px", letterSpacing: "0.2em", color: "rgba(255,255,255,0.6)" }}
                  >
                    ★ ★ ★ ★ ★
                  </div>
                  <p
                  ...
                  >
                    "An unforgettable trip — Bali is absolutely beautiful. Highly recommend NexTrip for such amazing
                    experiences."
                  </p>
                  <Hairline className="my-5" />
                  <div
                    className="flex items-center gap-3"
                    style={{ ...labelXS, color: "rgba(255,255,255,0.5)", letterSpacing: "0.2em" }}
                  >
                    <div
          ...
          <div className="relative mx-auto max-w-7xl px-8 py-32 md:py-48">
            ...
            <div className="relative grid gap-12 md:grid-cols-3 md:items-center md:gap-16">
              <Reveal>
                ...
                <div
                  className="space-y-3"
                  style={{ ...labelXS, fontSize: "10px", letterSpacing: "0.3em", color: "rgba(255,255,255,0.7)" }}
                >
                  {[
              ...
              <Reveal delay={0.15} y={36}>
                <Glass className="mx-auto w-full max-w-xs p-6">
                  <div
                    ...
                    style={{ ...labelXS, fontSize: "10px", color: "rgba(255,255,255,0.5)" }}
                  >
                    <span>≡</span>
                    <NWordmark />
                    <span>✎</span>
                  ...
                  <div className="mt-7 text-center">
                    ...
                    <div
                      className="mt-4"
                      style={{ fontFamily: fontDisplay, fontSize: "1.1rem", letterSpacing: "0.02em" }}
                    >
                      Daniel Jackson
                    </div>
                    <div
                      className="mt-2 inline-block rounded border px-2.5 py-1"
                      style={{
                        ...labelXS,
                        fontSize: "9px",
                        letterSpacing: "0.3em",
                  ...
                  <div className="mt-6 grid grid-cols-3 gap-2 text-center">
                    {[
                      ...
                      >
                        ...
                        <div
                          className="mt-1.5"
                          style={{ fontFamily: fontDisplay, fontSize: "1rem", color: "rgba(255,255,255,0.92)" }}
                        >
                          {v}
                        </div>
                      </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ color: "rgba(255,255,255,0.95)" }}>UA114</span>
                    </div>
                  </div>
                </Glass>
              </Reveal>
              ...
              <Reveal delay={0.3}>
                ...
                >
                  Hours and distances accumulated, quietly. Brag about them with friends — or measure yourself against
                  the journey.
                </p>
              </Reveal>
            </div>
          ...
          <div className="relative">
            ...
            <Reveal y={40}>
              <img
                ...
                style={{
                  filter: "drop-shadow(0 60px 120px rgba(0,0,0,0.95)) drop-shadow(0 0 80px rgba(220,232,250,0.10))",
                }}
              />
            </Reveal>
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, rgba(4,4,8,0.7), transparent 25%, transparent 75%, rgba(4,4,8,0.95))",
              }}
            />
            <div
              className="pointer-events-none absolute inset-0"
              ...
              <div className="mt-10 flex flex-wrap items-center justify-center gap-12">
                {["Figma File", "Prototype", "Contact"].map((l) => (
                  <a
                    ...
                    style={{ ...labelXS, fontSize: "10px", color: "rgba(255,255,255,0.7)", letterSpacing: "0.4em" }}
                  >
                    {l.toUpperCase()}
                    <span
                      className="absolute -bottom-1.5 left-0 right-0 h-px origin-left scale-x-0 transition-transform duration-300 group-hover:scale-x-100"
                      style={{ background: "rgba(220,232,250,0.9)" }}
                    />
                  </a>
                ))}
              </div>
